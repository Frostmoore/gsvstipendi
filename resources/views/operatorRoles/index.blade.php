<x-app-layout>
    ...
    <x-std-content>
        ...
        <div class="gsv-row-search">
            ...
            />
                <a href="{{ route('operatorRoles.create') }}" class="btn btn-primary mb-3">
                    ...
                    <tbody class="text-gray-700 dark:text-gray-200">
                        @foreach($operatorRoles as $role) 
                            <tr class="odd:bg-white odd:dark:bg-gray-700 even:bg-gray-50 even:dark:bg-gray-800 hover:bg-gray-100 hover:dark:bg-gray-600"
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('operatorRoles.edit', $role) }}" 
                                    class="btn btn-primary">
                                        <i class="fa-solid fa-pen-to-square gsv-edit px-2 py-2"></i>
                                    </a>
                                    <form action="{{ route('operatorRoles.destroy', $role) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
